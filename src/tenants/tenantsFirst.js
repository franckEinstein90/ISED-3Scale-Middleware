...
require('@src/tenants/tenantServices').addServiceInterface(tenants.Tenant.prototype)
require('@src/tenants/tenantAccounts').addAccountInterface(tenants.Tenant.prototype)
